...
@section('page-content')
                                ...
                                <div style="width: 300px" class="profile-contentname">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a data-bs-toggle="modal" data-bs-target="#smssendmodal"
                                                        class="btn btn-primary btn-sm text-white" type="button"
                                                        href="">Send
                                                        Sms</a></td>
    ...
    <!-- sms send modal -->
    <div class="modal fade" id="smssendmodal" tabindex="-1" aria-labelledby="smssendmodal" aria-hidden="true">
                ...
                <form action="{{ route('sms.send') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" value="{{ $student->sms_mobile }}" name="to" class="form-control"
                                required />
                        </div>
                        <div class="col-md-12 mb-3">
